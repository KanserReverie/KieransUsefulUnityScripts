...
namespace KieransUsefulUnityScripts.EventBusTemplate
{
    /// <summary>
    ...
    public static class StaticEventBusManager
    {
        ...
        /// </summary> 
        /// <param name="_eventBusEventToUnsubscribeFrom"> The EventBusEvent you are removing from selected UnityAction.</param> 
        ...
        /// 
        /// <para> This will Invoke all UnityActions linked to this EventBusEvent.</para>
        /// </summary>
